...
$resultsDir = Join-Path $projectRoot "tests/graphql/performance/results"
$apigwResults = Join-Path $resultsDir "hey-graphql-apigw-result.txt"
$ingressResults = Join-Path $resultsDir "hey-graphql-ingress-result.txt"
$echoApigwResults = Join-Path $resultsDir "hey-graphql-echo-apigw-result.txt"
$echoIngressResults = Join-Path $resultsDir "hey-graphql-echo-ingress-result.txt"
