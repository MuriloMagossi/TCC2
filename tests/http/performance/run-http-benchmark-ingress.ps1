...
$heyProcess = Start-Process -FilePath "./hey.exe" -ArgumentList "-c $conns -n $requests -z ${duration}s $targetUrl" -NoNewWindow -PassThru -RedirectStandardOutput "$resultsDir/hey-http-ingress-result.txt"
